...
VALUES (1, 'ristretto bianco', 'desc', 5.00, 6.00, FALSE, 30, 'coffee_baverage', 'admin'),
       ...
       (3, 'cappucino', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (4, 'iced long black', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (5, 'milk coffee regal', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (6, 'orange juice', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (7, 'soda beverage', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (8, 'iced coffee with milk', 'desc', 5.00, 6.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (9, 'iced americano', 'desc', 5.00, 5.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (10, 'vegan iced latte', 'desc', 5.00, 5.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (11, 'iced chocolate', 'desc', 5.00, 5.00, TRUE, 30, 'coffee_baverage', 'admin'),
       (12, 'autumnal coffee', 'desc', 5.00, 5.00, TRUE, 30, 'coffee_baverage', 'admin'),

       (13, 'seafood lunch', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (14, 'french toast with sugar', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (15, 'chocolate croissant', 'desc', 5.00, 6.00, TRUE, 30, 'food_snack', 'admin'),
       (16, 'potato wedges', 'desc', 5.00, 6.00, TRUE, 30, 'food_snack', 'admin'),
       (17, 'brownies', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (18, 'banana cake', 'desc', 5.00, 5.00, TRUE, 0, 'food_snack', 'admin'),
       (19, 'sandwiches and pickles', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (20, 'spaghetti bolognese', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (21, 'sandwich vegan', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),
       (22, 'eggs benedict burger', 'desc', 5.00, 5.00, TRUE, 0, 'food_snack', 'admin'),
       (23, 'corn cheese sandwich', 'desc', 5.00, 6.00, TRUE, 30, 'food_snack', 'admin'),
       (24, 'buttermilk waffle', 'desc', 5.00, 5.00, TRUE, 30, 'food_snack', 'admin'),

       (25, 'at home house blend', 'desc', 5.00, 5.00, TRUE, 30, 'at_home', 'admin'),
       (26, 'at home arabica', 'desc', 5.00, 5.00, TRUE, 0, 'at_home', 'admin'),
       (27, 'at home classic', 'desc', 5.00, 5.00, TRUE, 30, 'at_home', 'admin'),
       (28, 'white mug', 'desc', 5.00, 5.00, TRUE, 30, 'at_home', 'admin'),
       (29, 'at home kalosi', 'desc', 5.00, 5.00, TRUE, 0, 'at_home', 'admin'),
       (30, 'at home luwak', 'desc', 5.00, 5.00, TRUE, 0, 'at_home', 'admin'),
       (31, 'at home robusta', 'desc', 5.00, 5.00, TRUE, 30, 'at_home', 'admin'),
       (32, 'coffee temper 58 MM', 'desc', 5.00, 5.00, TRUE, 30, 'at_home', 'admin'),
       (33, 'french press 9 cups', 'desc', 25.00, 25.00, TRUE, 10, 'at_home', 'admin'),
       (34, 'glass tea pot teiera (6 cups)', 'desc', 13.00, 13.00, TRUE, 10, 'at_home', 'admin'),
       (35, 'french press 3 cup', 'desc', 20.00, 20.00, TRUE, 30, 'at_home', 'admin'),
       (36, 'moka pot', 'desc', 20.00, 20.00, TRUE, 30, 'at_home', 'admin');
